...
#define vehicle_state_init_default               {_TRIM_STATE_MIN, 0, 0, 0, 0, 0, 0, 0}
#define vehicle_state_init_zero                  {_TRIM_STATE_MIN, 0, 0, 0, 0, 0, 0, 0}
...
#define vehicle_state_hallPortTrip_tag           8
#define vehicle_state_hallStbdTrip_tag           9

/* Struct field encoding specification for nanopb */
extern const pb_field_t vehicle_state_fields[9];

/* Maximum encoded size of messages (where known) */
#define vehicle_state_size                       44

...
_BBBSERSORDATA = _descriptor.Descriptor(
  name='BBBSersorData',
  full_name='BBBSersorData',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='hall_port', full_name='BBBSersorData.hall_port', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='hall_stbd', full_name='BBBSersorData.hall_stbd', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='pot_val', full_name='BBBSersorData.pot_val', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='pot_centered', full_name='BBBSersorData.pot_centered', index=3,
...
DESCRIPTOR.message_types_by_name['BBBSersorData'] = _BBBSERSORDATA
...
BBBSersorData = _reflection.GeneratedProtocolMessageType('BBBSersorData', (_message.Message,), {
  'DESCRIPTOR' : _BBBSERSORDATA,
  '__module__' : 'MessagesServices_pb2'
  # @@protoc_insertion_point(class_scope:BBBSersorData)
  })
_sym_db.RegisterMessage(BBBSersorData)
...
_BBBSENSORREADER = _descriptor.ServiceDescriptor(
  name='BBBSensorReader',
  full_name='BBBSensorReader',
  file=DESCRIPTOR,
  index=3,
  serialized_options=None,
  ...
  _descriptor.MethodDescriptor(
    name='GetSensorData',
    full_name='BBBSensorReader.GetSensorData',
    index=0,
    containing_service=None,
    input_type=_SERVER_REQUEST,
    output_type=_BBBSERSORDATA,
    serialized_options=None,
  ),
])
_sym_db.RegisterServiceDescriptor(_BBBSENSORREADER)

DESCRIPTOR.services_by_name['BBBSensorReader'] = _BBBSENSORREADER
